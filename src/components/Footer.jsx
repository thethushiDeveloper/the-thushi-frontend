      ...
      <section className="social-media">
        <div className="social-media-wrap">
          <div className="footer-logo">
            {settings.logo ? <img src={`http://localhost:5000${settings.logo}`} alt="Logo" style={{ height: '30px', marginRight: '10px' }} /> : <Diamond className="logo-icon-sm" />} {settings.siteTitle || 'The Thushi'}
          </div>
